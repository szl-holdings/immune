    ...
    <div className="relative w-full bg-background text-foreground font-sans">
      ...
      <section className="relative flex h-screen w-full overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full p-6 z-20 flex justify-between items-start pointer-events-none">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-display font-bold tracking-widest leading-none flex items-center gap-3">
          ...
          <div className="flex flex-col items-end gap-1 font-mono text-xs uppercase tracking-widest">
        ...
        <motion.div
          ...
          className="absolute left-6 top-32 bottom-6 w-[320px] pointer-events-auto flex flex-col gap-6"
        >
          <div className="flex-1 bg-black/40 backdrop-blur-md border border-border/50 p-6 flex flex-col relative overflow-hidden group">
        ...
        <motion.div
          ...
          className="absolute right-6 top-32 bottom-6 w-[400px] pointer-events-auto flex flex-col gap-6"
        >
          <div className="flex-1 bg-black/40 backdrop-blur-md border border-border/50 p-6 flex flex-col relative overflow-hidden">
